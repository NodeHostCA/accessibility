...
function setDisplayMode(mode){
	...
	if (mode=="contrast"){
		...
		createCssRule("mode", "input,textarea,button", "border: 4px solid rgb(0,0,0) !important;color:rgb(69,130,240) !important;font-weight: 400 !important;text-decoration: none;overflow:hidden;");
